 ...
 *
 * Tests for PgRepo (L3 - direct database access, no caching).
 * Uses Uncached configurations that resolve to PgRepo via Repo<>.
 *
...
TEST_CASE("PgRepo<TestItem> - find", "[integration][db][base][item]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestItem> - insert", "[integration][db][base][item]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestItem> - update", "[integration][db][base][item]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestItem> - erase", "[integration][db][base][item]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestItem> - edge cases", "[integration][db][base][item][edge]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestItem> - JSON serialization", "[integration][db][base][item][json]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestUser> - find", "[integration][db][base][user]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestUser> - insert", "[integration][db][base][user]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestUser> - update", "[integration][db][base][user]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestUser> - erase", "[integration][db][base][user]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestPurchase> - find", "[integration][db][base][purchase]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestPurchase> - insert", "[integration][db][base][purchase]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestPurchase> - update", "[integration][db][base][purchase]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestPurchase> - erase", "[integration][db][base][purchase]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestPurchase> - multiple purchases per user", "[integration][db][base][purchase][multi]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo - patch multiple fields", "[integration][db][base][patch]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo - patch returns re-fetched entity", "[integration][db][base][patch]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestArticle> - find", "[integration][db][base][article]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestArticle> - insert", "[integration][db][base][article]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestArticle> - update", "[integration][db][base][article]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestArticle> - erase", "[integration][db][base][article]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestArticle> - edge cases", "[integration][db][base][article][edge]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestArticle> - JSON serialization", "[integration][db][base][article][json]") {
    TransactionGuard tx;
...
// #############################################################################
//
//  6. Read-only PgRepo — compile-time write enforcement
//
// #############################################################################

TEST_CASE("PgRepo - read-only configuration", "[integration][db][base][readonly]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo - uncached list queries (JSON)", "[integration][db][base][list]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo - uncached tracked list queries", "[integration][db][base][list-tracked]") {
    TransactionGuard tx;
    using Repo = uncached_list::UncachedArticleListRepo;
...
TEST_CASE("PgRepo - uncached list invalidation (no-ops)", "[integration][db][base][list-inv]") {
    TransactionGuard tx;
    using Repo = uncached_list::UncachedArticleListRepo;
...
TEST_CASE("PgRepo - uncached list queries (listAs)", "[integration][db][base][list-as]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestProduct> - insert with column= mapping", "[integration][db][base][product][column_mapping]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestProduct> - update with column= mapping", "[integration][db][base][product][column_mapping]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestProduct> - erase with column= mapping", "[integration][db][base][product][column_mapping]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo<TestProduct> - patch with column= mapping", "[integration][db][base][product][column_mapping][patch]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo - RowView byte-identity (TestUser)", "[integration][db][base][rowview]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo - RowView byte-identity (TestItem)", "[integration][db][base][rowview]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo - RowView byte-identity (TestProduct with column= mapping)", "[integration][db][base][rowview]") {
    TransactionGuard tx;
...
// #############################################################################
//
//  10. findJson / findBinary — Uncached (PgRepo direct, RowView path)
//
// #############################################################################

TEST_CASE("PgRepo - findJson (Uncached)", "[integration][db][base][findJson]") {
    TransactionGuard tx;
...
TEST_CASE("PgRepo - findBinary (Uncached)", "[integration][db][base][findBinary]") {
    TransactionGuard tx;
